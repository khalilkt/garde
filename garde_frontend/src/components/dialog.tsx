  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed left-1/2 top-1/2 z-20 flex h-screen w-screen -translate-x-1/2 -translate-y-1/2 lg:h-max lg:max-h-[90%] lg:w-max lg:rounded-2xl"
          forceMount
        >
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                className=" flex-col overflow-y-auto rounded-xl bg-white px-6 py-8 shadow-lg "
              >
