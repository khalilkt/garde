...
-- CREATE TABLE IF NOT EXISTS `pirogue_country` (
...
--
-- Dumping data for table `pirogue_country`
--

INSERT INTO `pirogue_country` (`id`, `code`, `alpha2`, `alpha3`, `name_en`, `name_fr`) VALUES
